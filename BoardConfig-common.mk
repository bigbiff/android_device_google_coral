...
#DEVICE_MANIFEST_FILE := device/google/coral/prebuilts/manifest.xml
...
TARGET_RECOVERY_DEVICE_MODULES += strace bootctrl.msmnile crash_dump android.hardware.authsecret@1.0.so android.hardware.oemlock@1.0.
